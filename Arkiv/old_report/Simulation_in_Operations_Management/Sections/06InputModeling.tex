...
\begin{figure}[H]
\centering
\includegraphics[width=0.32\textwidth]{figures/fig_fit_drying.pdf}\hfill
\includegraphics[width=0.32\textwidth]{figures/fig_fit_premix.pdf}\hfill
\includegraphics[width=0.32\textwidth]{figures/fig_fit_packaging.pdf}
\caption{Fitted distributions vs.\ data. Left: drying time with the Normal fit
(KS $p=0.92$) and the triangular actually implemented (dashed). Centre/right:
lognormal repair-time fits for the premix blenders ($p=0.24$) and the packaging
line ($p=0.66$).}
\label{fig:fits}
\end{figure}
